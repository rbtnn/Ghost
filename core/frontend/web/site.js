...
module.exports = function setupSiteApp(options = {}) {
    ...
    siteApp.use(mw.servePublicFile('built', 'public/backspacefm/DSC00694.png', 'image/png', constants.ONE_YEAR_S));
    siteApp.use(mw.servePublicFile('built', 'public/backspacefm/DSC00753.png', 'image/png', constants.ONE_YEAR_S));
    siteApp.use(mw.servePublicFile('built', 'public/backspacefm/DSC00812-8.png', 'image/png', constants.ONE_YEAR_S));
    siteApp.use(mw.servePublicFile('built', 'public/backspacefm/DSC00882.png', 'image/png', constants.ONE_YEAR_S));
    siteApp.use(mw.servePublicFile('built', 'public/backspacefm/DSC00921.png', 'image/png', constants.ONE_YEAR_S));
    siteApp.use(mw.servePublicFile('built', 'public/backspacefm/DSC01037.png', 'image/png', constants.ONE_YEAR_S));
    siteApp.use(mw.servePublicFile('built', 'public/backspacefm/IMG_1929.png', 'image/png', constants.ONE_YEAR_S));
    siteApp.use(mw.servePublicFile('built', 'public/backspacefm/apple-touch-icon-114x114-precomposed.png', 'image/png', constants.ONE_YEAR_S));
    siteApp.use(mw.servePublicFile('built', 'public/backspacefm/apple-touch-icon-144x144-precomposed.png', 'image/png', constants.ONE_YEAR_S));
    siteApp.use(mw.servePublicFile('built', 'public/backspacefm/apple-touch-icon-72x72-precomposed.png', 'image/png', constants.ONE_YEAR_S));
    siteApp.use(mw.servePublicFile('built', 'public/backspacefm/apple-touch-icon-precomposed.png', 'image/png', constants.ONE_YEAR_S));
    siteApp.use(mw.servePublicFile('built', 'public/backspacefm/c_amazonmusic.png', 'image/png', constants.ONE_YEAR_S));
    siteApp.use(mw.servePublicFile('built', 'public/backspacefm/c_google.png', 'image/png', constants.ONE_YEAR_S));
    siteApp.use(mw.servePublicFile('built', 'public/backspacefm/c_podcast.png', 'image/png', constants.ONE_YEAR_S));
    siteApp.use(mw.servePublicFile('built', 'public/backspacefm/c_rss.png', 'image/png', constants.ONE_YEAR_S));
    siteApp.use(mw.servePublicFile('built', 'public/backspacefm/c_spotify.png', 'image/png', constants.ONE_YEAR_S));
    siteApp.use(mw.servePublicFile('built', 'public/backspacefm/c_youtube.png', 'image/png', constants.ONE_YEAR_S));
    siteApp.use(mw.servePublicFile('built', 'public/backspacefm/drikin-mug1.png', 'image/png', constants.ONE_YEAR_S));
    siteApp.use(mw.servePublicFile('built', 'public/backspacefm/drikin_mazzo.png', 'image/png', constants.ONE_YEAR_S));
    siteApp.use(mw.servePublicFile('built', 'public/backspacefm/drikin_mazzo.png', 'image/png', constants.ONE_YEAR_S));
    siteApp.use(mw.servePublicFile('built', 'public/backspacefm/favicon.ico', 'image/ico', constants.ONE_YEAR_S));
    ...
    siteApp.use(mw.servePublicFile('built', 'public/backspacefm/mazzo-mug1.png', 'image/png', constants.ONE_YEAR_S));
    siteApp.use(mw.servePublicFile('built', 'public/backspacefm/mazzo-mug2.png', 'image/png', constants.ONE_YEAR_S));
    siteApp.use(mw.servePublicFile('built', 'public/backspacefm/mug-with-hand.png', 'image/png', constants.ONE_YEAR_S));
    siteApp.use(mw.servePublicFile('built', 'public/backspacefm/mugs-big.png', 'image/png', constants.ONE_YEAR_S));
    siteApp.use(mw.servePublicFile('built', 'public/backspacefm/navy-color-mug-big.png', 'image/png', constants.ONE_YEAR_S));
    siteApp.use(mw.servePublicFile('built', 'public/backspacefm/nezumi_icon5.png', 'image/png', constants.ONE_YEAR_S));
    siteApp.use(mw.servePublicFile('built', 'public/backspacefm/okita-mug.png', 'image/png', constants.ONE_YEAR_S));
    siteApp.use(mw.servePublicFile('built', 'public/backspacefm/red-color-mug-big.png', 'image/png', constants.ONE_YEAR_S));
    siteApp.use(mw.servePublicFile('built', 'public/backspacefm/twitter.png', 'image/png', constants.ONE_YEAR_S));
    siteApp.use(mw.servePublicFile('built', 'public/backspacefm/youtube.png', 'image/png', constants.ONE_YEAR_S));
