...
const OfferSuccess: React.FC<{ id: string }> = ({ id }) => {
  ...
  const handleTwitter = () => {
    window.open(
      `https://twitter.com/intent/tweet?url=${encodeURI(offerLink)}&text=${getShareText()}`,
      '_blank',
    );
  };
  ...
  const handleLinkedIn = () => {
    window.open(
      `http://www.linkedin.com/shareArticle?mini=true&url=${encodeURI(offerLink)}&title=${getShareText()}`,
      '_blank',
    );
  };
      ...
      <div className="-mt-6 flex h-full flex-col items-center justify-center text-center">
        ...
        <div className="mt-8 flex w-full max-w-md flex-col gap-8">
          ...
          <div className="flex gap-2">
            ...
            >
              <BrandIcon className="size-3.5!" name="twitter-x" />
            </Button>
            <Button
            ...
            >
              <BrandIcon className="size-3.5!" name="facebook" />
            </Button>
            <Button
            ...
            >
              <BrandIcon className="size-3.5!" name="linkedin" />
            </Button>
          </div>
        </div>
      </div>
